...
public class ResultBO implements Serializable {
    ...
    public static final Integer PURCHASE_PROHIBITION = -900001;
    public static final String MSG_PURCHASE_PROHIBITION_DESC = "系统暂不提供购买功能";
    ...
    public String toString() {
        return "ResultBO [code=" + code + ", msg=" + msg + "]";
    }
}
