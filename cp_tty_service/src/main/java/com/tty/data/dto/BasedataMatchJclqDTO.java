...
public class BasedataMatchJclqDTO implements Serializable{
    ...
    /** 过关玩法销售状态(1,1,1,1-->玩法都可售状态)  */
    private String saleState;

    /** s_dg_sale_state */
    private String dgSaleState;
    ...
    public String  getDgSaleState() {
        return dgSaleState;
    }

    public void setDgSaleState(String dgSaleState) {
        this.dgSaleState = dgSaleState;
    }
    ...
    public String toString() {
        return "BasedataMatchJclqDTO{"+"id="+id+",issueName="+issueName+",issueMatchName="+issueMatchName+",weekdayName="+weekdayName+",weekday="+weekday+",matchNo="+matchNo+",hostTeam="+hostTeam+",hostTeamId="+hostTeamId+",visitTeam="+visitTeam+",visitTeamId="+visitTeamId+",buyEndTime="+buyEndTime+",matchStartTime="+matchStartTime+",bgColor="+bgColor+",euroOdds="+euroOdds+",fullScore="+fullScore+",sfSp="+sfSp+",rfsfSp="+rfsfSp+",sfcSp="+sfcSp+",dxfSp="+dxfSp+",matchResult="+matchResult+",editStatus="+editStatus+",auditStatus="+auditStatus+",matchId="+matchId+",saleState="+saleState+",dgSaleState="+dgSaleState+",tournamentId="+tournamentId+",tournamentName="+tournamentName+",createTime="+createTime+"}";
    }
}